<%@ Page Title="" Language="C#" MasterPageFile="~/Gestion de Vehicule.Master" AutoEventWireup="true" CodeBehind="Admin Acceuil.aspx.cs" Inherits="SECOND_LAST.WebForm4" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script>
        ...
        <script>
            ...
            let nom_client_x = []
            let Mission_count_y = []
            Mission_count_y.push(0);
            nom_client_x.push(0);

            <%
            RADEETA_Entities db=new RADEETA_Entities();
            var get_all=(from DETAIL_MISSION in db.DETAIL_MISSION group new 
            ...
            {
                %>
            Mission_count_y.push("<%Response.Write(a.Counting.ToString());%>");
